...
let stretchPositives = [], stretchNegatives = [], stretchZeroes = []; // learned that I can declare multiple variables with one let from Eloquent JavaScript

for (i of supplyChanges) {
  if (i == 0) {
    stretchZeroes.push(0);
  } else if (i < 0) {
...
console.log('Parts left:', parts, 'Boxes Filled:', boxesFilled);
